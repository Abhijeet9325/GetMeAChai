...
const Footer = () => {
  ...
  return (
    <footer className='bg-slate-50 border-t border-slate-200 text-slate-900 pt-12 pb-8'>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-slate-800">Platform</h3>
            <ul className="space-y-2 text-sm text-slate-600">
              <li><Link href="/" className="">Home</Link></li>
              <li><Link href="/about" className="">About</Link></li>
              <li><Link href="/creators" className="">Creators</Link></li>
          ...
          {/* Support */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-slate-800">Support</h3>
            <ul className="space-y-2 text-sm text-slate-600">
              <li><Link href="/help" className="">Help Center</Link></li>
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-4">
              <a target="_blank" rel="noopener noreferrer" href="https://www.twitter.com/" className="p-2 bg-slate-100 rounded-full ">
              ...
              <a href="https://www.github.com/" target="_blank" rel="noopener noreferrer" className="p-2 bg-slate-100 rounded-full ">
              ...
              <a target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/" className="p-2 bg-slate-100 rounded-full ">
        ...
        <div className="border-t border-slate-200 pt-8 mt-8 flex flex-col md:flex-row justify-between items-center text-sm text-slate-500">
           <p>Made with ❤️ by <span className='text-slate-800 font-medium'>Abhijit Wankhade</span></p>
