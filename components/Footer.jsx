...
const Footer = () => {
  ...
  return (
    <footer className='bg-slate-950 border-t border-slate-800 text-white pt-12 pb-8'>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-4 group cursor-pointer">
              <div className="text-xl font-extrabold bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 bg-clip-text text-transparent group-hover:opacity-80 transition-opacity">
                GetMeAChai!
              </div>
              <img src="/tea.gif" width={24} alt="" className="group-hover:rotate-12 transition-transform" />
            </Link>
            <p className="text-slate-400 text-sm leading-relaxed">
              Empowering creators to fund their passions, one chai at a time. Join our community today.
            </p>
          </div>

          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-slate-200">Platform</h3>
            <ul className="space-y-2 text-sm text-slate-400">
              <li><Link href="/" className="hover:text-purple-400 transition-colors">Home</Link></li>
              <li><Link href="/about" className="hover:text-purple-400 transition-colors">About</Link></li>
              <li><Link href="/creators" className="hover:text-purple-400 transition-colors">Creators</Link></li>
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-4">
              <a target="_blank" rel="noopener noreferrer" href="https://www.twitter.com/" className="p-2 bg-slate-800 rounded-full hover:bg-purple-600 transition-colors group">
              ...
              <a href="https://www.github.com/" target="_blank" rel="noopener noreferrer" className="p-2 bg-slate-800 rounded-full hover:bg-purple-600 transition-colors group">
              ...
              <a target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/" className="p-2 bg-slate-800 rounded-full hover:bg-purple-600 transition-colors group">
            ...
            <p className="text-xs text-slate-500">
              © {currentYear} GetMeAChai. All rights reserved.
            </p>
          </div>
        ...
        <div className="border-t border-slate-800 pt-8 mt-8 flex flex-col md:flex-row justify-between items-center text-sm text-slate-500">
           <p>Made with ❤️ by <span className='text-purple-400 font-medium'>Abhijit Wankhade</span></p>
