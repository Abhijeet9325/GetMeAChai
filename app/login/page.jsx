  ...
  return (
    <div className='flex items-center justify-center min-h-[80vh] px-4'>
      <div className="w-full max-w-md bg-slate-900/60 backdrop-blur-md border border-slate-700/50 rounded-2xl shadow-2xl p-8 relative overflow-hidden group hover:border-slate-600/80 transition-all duration-300">
        ...
        <div className="absolute -top-24 -left-24 w-48 h-48 bg-purple-600/20 rounded-full blur-[60px] group-hover:bg-purple-600/30 transition-all duration-500"></div>
        <div className="absolute -bottom-24 -right-24 w-48 h-48 bg-blue-600/20 rounded-full blur-[60px] group-hover:bg-blue-600/30 transition-all duration-500"></div>
        ...
        <div className="relative z-10 flex flex-col items-center gap-6">
          ...
          <div className="w-full flex flex-col gap-3 mt-4">
            ...
            {/* <!-- Google --> */}
            <button
              className="flex cursor-pointer items-center justify-center gap-3 w-full bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 rounded-xl px-5 py-3 text-sm font-medium text-white transition-all duration-300 group/btn">
            ...
            {/* <!-- LinkedIn --> */}
            <button
              className="cursor-pointer flex items-center justify-center gap-3 w-full bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 rounded-xl px-5 py-3 text-sm font-medium text-white transition-all duration-300 group/btn">
            ...
            <button
              ...
              className="flex cursor-pointer  items-center justify-center gap-3 w-full bg-white text-black hover:bg-slate-200 border border-transparent rounded-xl px-5 py-3 text-sm font-bold shadow-lg shadow-white/10 transition-all duration-300 transform hover:-translate-y-0.5 group/btn">
