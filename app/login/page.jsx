...
const Login = () => {
  return (
    <div className='text-white mx-auto text-center py-24'>
     ...
     <div className="sociallogin">
      <div class="min-h-[20vh] flex flex-col items-center justify-center gap-3 p-6">

  {/* <!-- Google --> */}
  <button
    class="flex items-center gap-3 w-72 bg-white border border-gray-300 rounded-lg shadow-sm px-5 py-2 text-sm font-medium text-gray-800 hover:bg-gray-100 transition">
    <svg class="h-6 w-6" viewBox="-0.5 0 48 48">
  ...
  <button
    class="flex items-center gap-3 w-72 bg-white border border-gray-300 rounded-lg shadow-sm px-5 py-2 text-sm font-medium text-gray-800 hover:bg-gray-100 transition">
    <svg class="h-6 w-6 fill-[#0077B5]" viewBox="0 0 24 24">
  ...
  <button
    class="flex items-center gap-3 w-72 bg-white border border-gray-300 rounded-lg shadow-sm px-5 py-2 text-sm font-medium text-gray-800 hover:bg-gray-100 transition">
    <svg class="h-6 w-6 fill-[#1DA1F2]" viewBox="0 0 24 24">
