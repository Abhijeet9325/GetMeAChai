    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-6 py-12 text-white">
      ...
      <div className="w-full max-w-4xl text-center mb-16 relative">
        ...
        <h1 className="text-5xl md:text-6xl font-extrabold mb-6">
          About <span className="bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">GetMeAChai!</span>
        </h1>
      ...
      <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        {/* Mission Card */}
        <div className="bg-slate-900/50 backdrop-blur-md border border-slate-700/50 p-8 rounded-3xl shadow-xl hover:shadow-purple-500/10 transition-all duration-300 group">
        ...
        {/* How It Works Card */}
        <div className="bg-slate-900/50 backdrop-blur-md border border-slate-700/50 p-8 rounded-3xl shadow-xl hover:shadow-pink-500/10 transition-all duration-300 group">
      ...
      {/* Community Section */}
      <div className="w-full max-w-5xl mt-12 bg-gradient-to-r from-indigo-900/40 to-purple-900/40 border border-indigo-500/20 rounded-3xl p-8 md:p-12 text-center relative overflow-hidden">
        <div className="absolute top-0 right-0 w-64 h-64 bg-indigo-500/10 rounded-full blur-[60px] translate-x-1/2 -translate-y-1/2"></div>
        
        <h2 className="text-3xl font-bold mb-6 text-white relative z-10">Join the Community</h2>
